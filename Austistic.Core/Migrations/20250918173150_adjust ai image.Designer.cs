...
namespace Austistic.Core.Migrations
{
    ...
    [Migration("20250918173150_adjust ai image")]
    partial class adjustaiimage
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Austistic.Core.Entities.ApplicationUser", b =>
                {
                    ...
                    b.Property<bool>("ShouldShowOnSearch")
                        .HasColumnType("boolean");
            ...
            modelBuilder.Entity("Austistic.Core.Entities.CategorySymbol", b =>
                {
                    ...
                    b.ToTable("CategorySymbol");
                });

            modelBuilder.Entity("Austistic.Core.Entities.ConfirmEmailToken", b =>
                {
                    b.Property<string>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("Austistic.Core.Entities.ForgetPasswordToken", b =>
                {
                    b.Property<string>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("Austistic.Core.Entities.SymbolImage", b =>
                {
                    ...
                    b.Property<string>("CategorySymbolId")
                        .IsRequired()
                        .HasColumnType("text");
                    ...
                    b.Property<string>("SymbolIdentifier")
                        .IsRequired()
                        .HasColumnType("text");

                    b.HasKey("Id");

                    b.HasIndex("CategorySymbolId");

                    b.ToTable("SymbolImage");
                });

            modelBuilder.Entity("Austistic.Core.Entities.UserSymbolAttachedProcess", b =>
                {
                    b.Property<string>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("text");
                    ...
                    b.ToTable("UserSymbolAttachedProcess");
                });
            ...
            modelBuilder.Entity("Austistic.Core.Entities.ConfirmEmailToken", b =>
                {
                    b.HasOne("Austistic.Core.Entities.ApplicationUser", "User")
                        ...
                        .HasForeignKey("Austistic.Core.Entities.ConfirmEmailToken", "UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Austistic.Core.Entities.ForgetPasswordToken", b =>
                {
                    b.HasOne("Austistic.Core.Entities.ApplicationUser", "user")
                        ...
                        .HasForeignKey("Austistic.Core.Entities.ForgetPasswordToken", "userid")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Austistic.Core.Entities.Friend", b =>
                {
                    b.HasOne("Austistic.Core.Entities.ApplicationUser", "FriendUser")
                        .WithMany()
            ...
            modelBuilder.Entity("Austistic.Core.Entities.RoomMessages", b =>
                {
                    ...
                    b.HasOne("Austistic.Core.Entities.ApplicationUser", "SentBy")
                        .WithMany()
            ...
            modelBuilder.Entity("Austistic.Core.Entities.SymbolImage", b =>
                {
                    b.HasOne("Austistic.Core.Entities.CategorySymbol", "CategorySymbol")
                        .WithMany("SymbolImages")
                        .HasForeignKey("CategorySymbolId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("CategorySymbol");
                });
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("Austistic.Core.Entities.ApplicationUser", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
